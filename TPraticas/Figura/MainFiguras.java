...
public class MainFiguras {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n### Listagem das Areas das figuras ###");
        ...
        System.out.println("\n### Listagem de Figuras que sao instancia de Retangulo e Circulo ###");
        for (int i = 0; i < figuras.length; i++) {
            if (figuras[i] instanceof Retangulo) {
                System.out.println("Instancia de Retangulo: " + figuras[i]);
            }
            else if (figuras[i] instanceof Circulo) {
                System.out.println("Instancia de Circulo: " + figuras[i]);
            }
        }
