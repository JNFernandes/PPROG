...
public class Carta implements Comparable<Carta>{
    ...
    public int compareTo(Carta o) {
        String tipo1 = String.valueOf(this.getTipo());
        String tipo2 = String.valueOf(o.getTipo());
        String naipe1 = String.valueOf(this.getNaipe());
        String naipe2 = String.valueOf(o.getNaipe());
